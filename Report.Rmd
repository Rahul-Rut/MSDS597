...
### Note: Be sure to close the shiny tab WHILE runnig chunk wise. Otherwise the RStudio gets stuck "Listening on http://127.0.0.1:7302". Other way to escape the same is by hitting the escape key in the console tab
